...
label start:
    ...
    "Und dann eine weitere Stimme, die weniger ...{w} fröhlich klingt.{w} Um ehrlich zu sein, klingt sie sogar eher verärgert."
    ...
    "{i}Whap!{/i} Das ernstere Mädchen 'schlägt' mit ihrer Faust auf den Kopf des anderen Mädchens, die gerade in einer 'Tut mir leid, mein Fehler'-Manier ihre Zunge ausstreckt."
    ...
    menu:
        ...
        "Diese Mädchen spinnen doch.":
            ...
            "{i}BAM.{/i} Da landet die Faust direkt im Gesicht des fröhlichen Mädchens.{w} Und dieses Mal war es ernst gemeint, denn sie hielt sich kein bisschen zurück.{w} Das sah aus, als hätte es echt wehgetan ..."
