...
label start:
    ...
    "Jede Nacht ...{w} habe ich denselben aöasöasdjböasjdbölajs Traum."
...
label explanationover:
    ...
    if hikari > sayaka:
        ...
        tg "Währen der Arbeit schlafen?{w} Was eine Überraschung.{w} Was werden wir jetzt mit dir machen?"
